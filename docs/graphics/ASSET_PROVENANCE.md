...
| All block/terrain textures | generated at runtime by `com.veylon.gfx.ProceduralTextures` | original, written for this project | project-owned; no repository-wide redistribution license declared |
| All UI icons | generated at runtime by `com.veylon.gfx.IconAtlas` | original | project-owned; no repository-wide redistribution license declared |
